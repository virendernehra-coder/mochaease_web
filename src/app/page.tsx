...
import { BarChart3, Clock, Rocket, Shield, Settings2, FileText, Smartphone, Coffee, Store, Users, Zap, CheckCircle2, Globe, X, Send, Sparkles, MessageSquare, Loader2 } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center overflow-x-hidden relative bg-[#050505] selection:bg-[#C3EB7A]/30">
      ...
      {/* Hero Section */}
      <section className="relative w-full max-w-5xl mx-auto px-6 pt-40 pb-32 flex flex-col items-center text-center z-10 min-h-screen justify-center">
        ...
        <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="flex flex-col items-center">
          ...
          <motion.h1 variants={fadeUpVariant} className="text-6xl md:text-8xl font-black tracking-tighter mb-8 text-transparent bg-clip-text bg-gradient-to-b from-white to-white/60 leading-[1.1]">
      ...
      <section id="features" className="w-full max-w-7xl mx-auto px-6 py-32 z-10 relative">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="w-full max-w-6xl mx-auto px-6 py-32 z-10 relative">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUpVariant} className="text-center mb-20">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div variants={fadeUpVariant} className="p-8 rounded-3xl bg-white/5 border border-white/10 flex flex-col">
            ...
            <div className="flex items-baseline mb-8">
              <span className="text-4xl font-black text-white">₹{isAnnual ? Math.floor(1399 * 0.8) : 1399}</span>
          ...
          <motion.div variants={fadeUpVariant} className="p-8 rounded-3xl bg-gradient-to-b from-[#C3EB7A]/10 to-[#1A1A1A] border border-[#C3EB7A]/30 flex flex-col relative transform md:-translate-y-4 shadow-[0_0_40px_rgba(195,235,122,0.1)]">
            ...
            <div className="flex items-baseline mb-8">
              <span className="text-4xl font-black text-[#C3EB7A]">₹{isAnnual ? Math.floor(1999 * 0.8) : 1999}</span>
              <span className="text-lg text-white/50 font-normal ml-1">/mo</span>
            </div>
            <ul className="space-y-4 mb-8 flex-1">
          ...
          <motion.div variants={fadeUpVariant} className="p-8 rounded-3xl bg-white/5 border border-white/10 flex flex-col">
            ...
            <div className="flex items-baseline mb-8">
              <span className="text-4xl font-black text-white">₹{isAnnual ? Math.floor(2999 * 0.8) : 2999}</span>
              <span className="text-lg text-white/50 font-normal ml-1">/mo</span>
            </div>
            <ul className="space-y-4 mb-8 flex-1">
          ...
          >
            ...
            <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-[#4A90E2] to-purple-500 p-[2px] shadow-[0_0_30px_rgba(74,144,226,0.4)] group-hover:scale-110 transition-transform">
              <div className="w-full h-full rounded-full bg-black flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-t from-[#4A90E2]/40 to-transparent"></div>
                <Users className="w-7 h-7 text-white absolute bottom-2" />
              </div>
            </div>
          </motion.div>
        )}
