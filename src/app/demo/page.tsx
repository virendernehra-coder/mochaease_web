...
import { Calendar, Clock, Rocket, CheckCircle2, Building2, User, Mail, Phone } from 'lucide-react';
                    ...
                    <div className="w-full max-w-lg bg-[#1A1A1A]/90 p-8 md:p-10 rounded-[40px] border border-white/10 shadow-[0_20px_80px_rgba(0,0,0,0.8)] backdrop-blur-2xl relative overflow-hidden group">
                        ...
                        <form className="space-y-5 relative z-10">
                            ...
                            <div className="space-y-2 pt-2">
                                ...
                                <select className="w-full bg-[#0A0A0A] border border-white/10 rounded-2xl py-4 px-4 text-white focus:outline-none focus:border-[#C3EB7A]/50 focus:ring-1 focus:ring-[#C3EB7A]/50 transition-all font-medium appearance-none cursor-pointer">
                            ...
                            <button
                                type="submit"
                                className="w-full mt-6 py-4 rounded-xl bg-[#C3EB7A] text-black font-black text-lg hover:brightness-110 hover:scale-[1.02] active:scale-95 transition-all shadow-[0_0_20px_rgba(195,235,122,0.4)] flex items-center justify-center gap-2"
                            >
                                Schedule My Demo
