...
export default function TopSellingProducts() {
    ...
    return (
        <motion.div 
            ...
            className="rounded-[32px] bg-[#0F0F0F]/80 border border-white/5 backdrop-blur-3xl p-8 overflow-hidden group"
        >
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    <div className="p-3 rounded-2xl bg-[#4A90E2]/10 text-[#4A90E2] border border-[#4A90E2]/20">
                        <ShoppingBag className="w-5 h-5" />
                    </div>
                    <div>
                        <h3 className="text-sm font-black text-white/40 uppercase tracking-[2px]">Market Leaderboard</h3>
                ...
                <button className="px-6 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white font-black text-[10px] uppercase tracking-widest hover:bg-white/10 transition-all flex items-center gap-2">
